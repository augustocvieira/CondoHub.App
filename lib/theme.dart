...
/// Modern color palette for condominium management app
class LightModeColors {
  // Primary: Professional teal-blue for trust and stability
  static const lightPrimary = Color(0xFF0D7377);
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFB8E6E9);
  static const lightOnPrimaryContainer = Color(0xFF002021);

  // Secondary: Warm orange for actions and highlights
...
class DarkModeColors {
  ...
  static const darkPrimary = Color(0xFF32E0C4);
  static const darkOnPrimary = Color(0xFF00363A);
  static const darkPrimaryContainer = Color(0xFF005457);
  static const darkOnPrimaryContainer = Color(0xFFB8E6E9);

  // Secondary: Bright orange for dark mode
  static const darkSecondary = Color(0xFFFF8C61);
  static const darkOnSecondary = Color(0xFF4D1800);

  // Tertiary
  static const darkTertiary = Color(0xFF6EFFD2);
  static const darkOnTertiary = Color(0xFF00382D);
